...
/* Get country list from JSON file or fallback to hardcoded list */
    ...
    <div class="container">
        <div class="register-container">
            <div class="register-header">
                <h2><?php echo $step === 'otp' ? 'Verify Your Email' : 'Create Your Account'; ?></h2>
                <p><?php echo $step === 'otp' ? 'Enter the 6-digit code sent to your email' : 'Join Grand Hotel for exclusive offers and seamless booking'; ?></p>
            </div>
                ...
                <form method="POST" action="process/register_process.php" novalidate>
                    ...
                    <div class="password-section">
                        <div class="form-group">
                            ...
                            <div class="password-rules">
                                <ul class="rules-list">
                                    <li id="req-length" class="rule-item"><span class="rule-icon">•</span><span class="rule-text">Must be between 8 and 16 characters</span></li>
                                    <li id="req-lower" class="rule-item"><span class="rule-icon">•</span><span class="rule-text">Contain one lowercase letter</span></li>
                                    <li id="req-number" class="rule-item"><span class="rule-icon">•</span><span class="rule-text">One number (0-9) or one special character</span></li>
                                    <li id="req-upper" class="rule-item"><span class="rule-icon">•</span><span class="rule-text">Contain one uppercase letter</span></li>
                                </ul>
                            </div>
                    ...
                    <div class="full-width" style="margin-top: 1.5rem;">
                        <div class="checkbox-group">
                            ...
                            <label for="terms">I agree to the <a href="terms.php" style="color: var(--gold);">Terms & Conditions</a> and <a href="privacy.php" style="color: var(--gold);">Privacy Policy</a> *</label>
                        </div>
